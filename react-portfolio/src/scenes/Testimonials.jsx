  ...
  return (
    <section id="testimonials" className="pt-32 pb-16">
      ...
      >
        ...
        <LineGradient width="ms-auto w-2/4" />
        <p className="mt-10">
      ...
      <div className="md:flex md:justify-between gap-8">
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-center text-xl">Lorem ipsum dolor sit amet blat uitmsv.</p>
        </motion.div>
        ...
        >
          <p className="font-playfair text-6xl">"</p>
          <p className="text-center text-xl">Lorem ipsum dolor sit aamsbt sbfghf.</p>
        </motion.div>
      </div>
    </section>
  );
